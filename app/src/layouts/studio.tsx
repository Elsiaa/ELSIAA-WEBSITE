  ...
  return (
    <Sidebar.Root product="marketing-studio" flush>
      ...
      <Sidebar.Body>
        <Sidebar.Section>
          <Sidebar.SectionItems>
            ...
            />
            <Sidebar.Item
              start={<IconTile as={IconImages1Outlined} gradient="teal" />}
        ...
        <Sidebar.Section>
          ...
          <Sidebar.SectionItems>
            <Sidebar.Item
              start={<IconTile as={IconChainLink3Outlined} gradient="blue" />}
              title="Url to Ad"
            />
            <Sidebar.Item
              start={<IconTile as={IconImagesSparkleOutlined} gradient="teal" />}
              title="Ad Reference"
            />
            <Sidebar.Item
              start={<IconTile as={IconTiktokOutlined} gradient="blue" />}
              title="Manage TikTok"
            />
          </Sidebar.SectionItems>
        </Sidebar.Section>
        ...
        <Sidebar.Section>
          ...
          <Sidebar.SectionItems>
            <Sidebar.Item
              variant="project"
              start={<Sidebar.ProjectThumbnail src={COVERS[0]} />}
              title="Aurora Labs"
              meta="221"
            />
            <Sidebar.Item
              variant="project"
              start={<Sidebar.ProjectThumbnail src={COVERS[1]} />}
              title="Pixel Forge"
              meta="18"
              onPinChange={() => {}}
              pinned
            ...
            <Sidebar.Item
              variant="project"
              start={<Sidebar.ProjectThumbnail src={COVERS[2]} />}
              title="Blue Horizon"
              meta="484"
            />
            <Sidebar.Item
              variant="project"
              start={<Sidebar.ProjectThumbnail src={COVERS[3]} />}
              title="Nova"
              meta="156"
            />
            <Sidebar.Item
      ...
      <Sidebar.Footer>
        <Sidebar.FooterItem
          variant="promo"
          start={<Icon as={IconDiamondFilled} size="md" />}
          title="Pricing"
          end={<Sidebar.PromoBadge />}
        />
        <Sidebar.FooterItem
          variant="login"
          start={<Icon as={IconPeopleOutlined} size="md" />}
          title="Login"
        />
      </Sidebar.Footer>
    </Sidebar.Root>
    ...
    <PromptBox.Root surface={surface} className={className}>
      <PromptBox.ModeRail hidden={!showModeToggle}>
        <PromptBox.Mode
          ...
          start={<Icon as={Icon3dBoxTopOutlined} size="md" />}
        >
          Product
        </PromptBox.Mode>
        <PromptBox.Mode
          active={mode === "app"}
          onClick={() => setMode("app")}
          start={<Icon as={IconWorldOutlined} size="md" />}
        >
          App
        </PromptBox.Mode>
      </PromptBox.ModeRail>
      ...
      <PromptBox.Body>
        <PromptBox.Field
          ...
          aria-label="Describe the scene you imagine"
        />
        <PromptBox.Actions>
          {add ? (
            <AssetLibraryModal
        ...
        <div className="flex flex-col items-center gap-8">
          <div className="flex flex-col items-center gap-2">
            <Typography
              ...
              color="secondary"
              className="text-[1rem]! leading-[1.25rem]!  opacity-60"
            >
              Marketing Studio
            </Typography>
            <Typography
              as="h1"
              variant="headline-lg-bold"
              color="primary"
...
function AfterPromptDock() {
  return (
    <div className="pointer-events-none absolute inset-x-0 bottom-4 flex justify-center px-4">
      <StudioPromptBox
        surface="glass"
        className="pointer-events-auto w-[900px] max-w-full border-none"
      />
    </div>
  );
}
  ...
  return (
    <div className="fixed right-4 top-3 z-50">
      <Tabs.Root
        variant="segmented"
        value={value}
        onValueChange={(v) => onChange(v as StudioState)}
      >
...
export function StudioTemplate({ state }: StudioTemplateProps) {
  ...
  return (
    <div className="flex h-dvh overflow-hidden bg-q-background-primary">
      <StudioSidebar />
      <main className="relative flex min-w-0 flex-1 flex-col">{canvas}</main>
