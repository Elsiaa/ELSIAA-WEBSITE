...
const STEPS: { title: string; description: string; preview: ReactNode }[] = [
  {
    ...
    description:
      "Choose an image or drag and drop a file. Add a portrait, selfie, or any photo with a character.",
    preview: (
  ...
  },
  {
    ...
    description:
      "Click the button and transform your photo according to the preset you\u2019re in.",
    preview: (
  ...
  return (
    ...
    >
            ...
            <AssetLibraryModal
              ...
              trigger={
                <Dropzone
                  ...
                  preview={
                    image != null ? <DropzonePreview src={image} alt="Selected image" /> : undefined
                  }
                />
              }
            />
      ...
      <div className="relative flex-1">
        {stage === "generating" ? (
          <GenerationCard state="generating" ratio={671 / 560} className="h-full w-full" />
        ) : stage === "result" ? (
          <GenerationCard
            ratio={671 / 560}
            src={HERO_RESULT}
