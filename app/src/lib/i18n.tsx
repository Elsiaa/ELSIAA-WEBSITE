...
const DICT: Record<string, Row> = {
  ...
  "Executive Legal & Strategic Counsel": { es: "Consejero Ejecutivo Legal y Estratégico", fr: "Conseiller juridique et stratégique exécutif", de: "Leiter Recht & Strategieberatung", ru: "Исполнительный юридический и стратегический советник", nl: "Uitvoerend Juridisch & Strategisch Adviseur", he: "יועץ משפטי ואסטרטגי בכיר", yi: "עקזעקוטיווער יוריסטישער און סטראַטעגישער יועץ" },
