...
const GROUPS: Group[] = [
  {
    ...
    items: [
      {
        name: "Brand Identity",
        blurb: "Logo, palette, type, and the rules that hold it together.",
        price: "Quote",
      },
      {
        name: "Website Design",
        blurb: "A site engineered to be believed — designed, built, shipped.",
        price: "Quote",
      },
      {
        name: "Product & Campaign Imagery",
        blurb: "One phone photo in, a full campaign out.",
        price: "Quote",
      },
      {
        name: "App & Dashboard Design",
        blurb: "Interfaces your users don't need a manual for.",
        price: "Quote",
      },
    ],
  },
    ...
    items: [
      {
        ...
        blurb: "Sales, operations, finance — running while you sleep.",
        price: "Quote",
      },
      {
        name: "AI Chatbots & Agents",
        blurb: "Front-line answers and back-office hands, around the clock.",
        price: "Quote",
      },
      {
        name: "CRM & Pipeline Automation",
        blurb: "Every lead followed up, every stage tracked, automatically.",
        price: "Quote",
      },
    ],
  },
  {
    ...
    items: [
      { name: "MVP Build", blurb: "First wireframe to live product, fast.", price: "Quote" },
      {
        ...
        blurb: "SaaS, internal tools, client portals — built to spec.",
        price: "Quote",
      },
  ...
  },
  {
    ...
    items: [
      {
        name: "Basic — one session",
        blurb: "A 1-on-1 strategy call plus a written action plan in 48h.",
        price: "$350",
      },
      {
        name: "Sprint — two weeks",
        blurb: "We don't just advise; we implement the first fix with you.",
        price: "$1,850",
      },
      {
        name: "Advisory — monthly",
        blurb: "ELSIAA as your standing technology counsel.",
        price: "Custom",
      },
    ],
  },
              ...
              <li key={p.name}>
                ...
                >
                  <div className="min-w-0">
                    <h3
                      className="text-[15.5px] font-semibold tracking-[-0.01em] text-[#111111]"
                      style={inter}
                    >
                      {p.name}
                    </h3>
