    ...
    <div className="flex h-full w-full items-center justify-center gap-1.5">
      {"ELSIAA".split("").map((ch, i) => (
        <span
          ...
          style={{ animationDelay: `${i * 0.16}s`, fontFamily: "var(--font-sans)" }}
        >
          {ch}
        </span>
      ))}
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-1 flex-col p-5">
        ...
        <p className="mt-1 text-[13px] leading-relaxed text-[#111111]/60" style={{ fontFamily: "var(--font-sans)" }}>
          {service.blurb}
        </p>
        <div
        ...
        >
          <div className="overflow-hidden">
            <p className="text-[13px] leading-relaxed text-[#111111]/65" style={{ fontFamily: "var(--font-sans)" }}>
              {service.detail}
            </p>
            <a
...
function CategoryBlock({ cat }: { cat: Category }) {
  ...
  return (
    <div ref={ref} className="ds-cat mx-auto max-w-6xl px-6 py-10 md:py-16">
      <p
      ...
      <p className="mt-3 max-w-xl text-base text-[#111111]/60 md:text-lg" style={{ fontFamily: "var(--font-sans)" }}>
        {cat.lead}
      </p>
