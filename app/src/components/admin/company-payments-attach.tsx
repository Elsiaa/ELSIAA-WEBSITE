      ...
      {loading ? (
        ...
        <Card>
          <CardContent className="py-12 text-center">
            <DollarSign className="w-12 h-12 mx-auto mb-4 text-[#111]/55" />
            <p className="text-[#111]/55">No payments found</p>
          </CardContent>
        </Card>
      ) : (
        (() => {
                ...
                <AccordionTrigger className="px-4 py-3 hover:no-underline">
                  <div className="w-full text-left space-y-1">
                    <div className="flex flex-wrap items-center justify-between gap-2">
                      ...
                      <span className="text-[#111]/55 text-sm">{projectName}</span>
              ...
              <div className="space-y-8">
                ...
                <div className="space-y-2">
                  ...
                  {oneTimeList.length === 0 ? (
                    <p className="text-sm text-[#111]/55 py-4">No one-time payments.</p>
                  ) : (
                    <div className="space-y-2">
