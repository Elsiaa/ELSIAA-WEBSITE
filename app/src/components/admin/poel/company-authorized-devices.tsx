                ...
                <div className="flex items-center justify-between flex-wrap gap-2">
                  <div className="flex flex-col">
                    ...
                    {githubStatusByProject[project.id]?.hasGithubUrl && (
                      <div className="mt-2 flex flex-col gap-1">
                        ...
                        <span className="text-xs text-muted-foreground whitespace-nowrap">Software Version:</span>
                  ...
                  <div className="flex items-center gap-2 flex-wrap">
                    <span className="text-sm font-medium text-muted-foreground">
                      ...
                      {lim == null && <span className="text-muted-foreground font-normal"> (no limit)</span>}
                    </span>
                        ...
                        {editingAuthDeviceId === d.id ? (
                          ...
                          <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                            <div className="flex-1 min-w-0 flex flex-wrap items-center gap-2">
                              ...
                              {d.deviceId ? (
                                <span className="text-xs text-muted-foreground font-mono break-all">{d.deviceId}</span>
                              ) : null}
                            </div>
