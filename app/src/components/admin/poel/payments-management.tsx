        ...
        <CardContent className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <div className="space-y-2 rounded-md border border-dashed border-border bg-muted/20 p-3">
              <Label htmlFor="create-line-paste" className="text-xs font-medium text-muted-foreground">
          ...
          <div className="space-y-1">
            ...
            />
            <p className="text-xs text-muted-foreground">Leave empty to make the charge due immediately.</p>
          </div>
            ...
            <div className="space-y-3">
                          ...
                          <div className="flex-1 text-left">
                            ...
                            <div className="text-sm text-muted-foreground">
                              ...
                              {req.payment_type === 'one_time' && req.next_billing_date && (
                                <span className="ml-2 text-muted-foreground">Due: {new Date(req.next_billing_date).toLocaleDateString()}</span>
                              )}
                            </div>
                            ...
                            <AccordionItem value={`${req.id}-${idx}`} className="border-none">
                              ...
                              <AccordionContent className="px-3 pb-3">
                                {req.invoice_line_items && req.invoice_line_items.length > 0 ? (
                                  ...
                                  <p className="text-sm text-muted-foreground pt-2 border-t">No line-item breakdown stored for this invoice.</p>
                                )}
                              </AccordionContent>
                            </AccordionItem>
                          </Accordion>
              ...
              <TabsContent value="project-transactions" className="mt-4">
                {loadingProjectTransactions ? (
                  ...
                  <div className="space-y-2">
                    <p className="text-muted-foreground">Project payment history is not loaded yet.</p>
            ...
            <div className="space-y-4 py-4">
              ...
              {editingRequest.payment_type === 'one_time' ? (
                <div className="space-y-2">
                  ...
                  <div className="space-y-2 rounded-md border border-dashed border-border bg-muted/20 p-3">
                    <Label htmlFor="edit-line-paste" className="text-xs font-medium text-muted-foreground">
                      Paste from billing (description;; qty;; unit price;; …)
                    </Label>
                    <Textarea
                      id="edit-line-paste"
