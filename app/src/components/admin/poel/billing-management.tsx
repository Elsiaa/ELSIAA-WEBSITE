              ...
              {cronResultView === "live" ? (
                <div className="grid grid-cols-2 gap-3">
                  <Card>
                    <CardContent className="pt-4">
                      <p className="text-muted-foreground">Subscriptions charged</p>
                  ...
                  <Card>
                    <CardContent className="pt-4">
                      <p className="text-muted-foreground">Overdue warnings sent</p>
                ...
                <>
                  <div className="grid grid-cols-3 gap-3">
                    ...
                    <Card>
                      <CardContent className="pt-4">
                        <p className="text-muted-foreground text-xs">Payment requests</p>
                        <p className="text-xl font-semibold">
