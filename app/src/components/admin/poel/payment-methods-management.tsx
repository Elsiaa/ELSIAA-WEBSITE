...
export default function PaymentMethodsManagement({
  ...
  const [selectedPaymentType, setSelectedPaymentType] = useState<"card" | "us_bank_account">(
    "card",
  );
                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-muted-foreground capitalize">
                      {method.paymentMethodType === "us_bank_account"
                        ? PAYMENT_METHOD_LABEL_ACH
                        : PAYMENT_METHOD_LABEL_CARD}
                    </p>
                    {method.last4 && (
                      <p className="text-xs text-muted-foreground mt-1">•••• {method.last4}</p>
                    )}
                  </div>
                  <Button
                    variant="ghost"
