...
export default function CompanyFileStorage({
  ...
  return (
    <div className="space-y-6">
      <Card className="border-black/[0.08]/80 shadow-sm">
        <CardHeader className="border-b border-black/[0.08]/50 bg-black/[0.04]/20 pb-4">
        ...
        <CardContent className="space-y-5 pt-6">
          {multiCompanyPicker && !effectiveCompanyId ? (
            <div className="rounded-xl border-2 border-dashed border-black/[0.08]/60 bg-white overflow-hidden">
              <div className="px-4 py-3 border-b border-black/[0.08]/50 bg-black/[0.04]/30 text-sm text-[#111]/55">
                Companies — click a folder to manage that company&apos;s files
              </div>
              {companies.length === 0 ? (
                <p className="px-4 py-12 text-center text-sm text-[#111]/55">
                    ...
                    .map((c) => (
                      <li key={c.id}>
                        <button
                          ...
                          className="flex w-full items-center gap-3 px-4 py-4 text-left transition-colors hover:bg-black/[0.04]/40 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
                        >
                          <Folder className="h-6 w-6 shrink-0 text-amber-500/90" />
                          <span className="min-w-0 flex-1">
                            <span className="block truncate font-medium text-base">{c.name}</span>
                            <span className="text-xs text-[#111]/55">Company file storage</span>
                          </span>
                          <ChevronRight className="h-5 w-5 shrink-0 text-[#111]/55" />
                        </button>
                      </li>
                    ))}
                </ul>
          ...
          {effectiveCompanyId ? (
            <>
              ...
              >
                ...
                <div className="hidden lg:grid lg:grid-cols-[minmax(0,1fr)_6rem_8.5rem_auto] gap-2 px-4 py-2.5 text-xs font-medium uppercase tracking-wide text-[#111]/55 border-b border-black/[0.08]/50 bg-black/[0.04]/30">
                ...
                !batchProgress ? (
                  <div className="flex flex-col items-center justify-center gap-3 py-16 text-[#111]/55">
                  ...
                  <button
                    ...
                    className="w-full py-16 px-4 text-center text-sm text-[#111]/55 space-y-2 rounded-b-lg transition-colors hover:bg-black/[0.04]/40 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50"
                  >
                  ...
                  <ul className="divide-y divide-border/40">
                    ...
                    {activeUploads.map((u) => (
                      ...
                      >
                        ...
                        <span className="text-sm text-[#111]/55 pl-8 lg:pl-0">
                          {formatBytes(u.size)}
                        </span>
                    ...
                    {folders.map((f) => (
                      ...
                      >
                        <button
                          ...
                          className="flex min-w-0 items-center gap-3 rounded-md text-left outline-offset-2 hover:bg-black/[0.04]/40 focus-visible:ring-2 focus-visible:ring-ring py-1 -my-1 px-1 -mx-1 lg:min-w-0"
                        >
                          <Folder className="h-5 w-5 shrink-0 text-amber-500/90" />
                          <span className="truncate font-medium">{f.name}</span>
                          <ChevronRight className="h-4 w-4 shrink-0 text-[#111]/55 ml-auto lg:ml-0" />
                        </button>
                    ...
                    {files.map((f) => (
                      ...
                      >
                        <span className="flex items-center gap-2 min-w-0 lg:min-w-0 cursor-grab active:cursor-grabbing">
                          <GripVertical
                            className="h-4 w-4 shrink-0 text-[#111]/55/60 hidden sm:block"
                            aria-hidden
                          />
