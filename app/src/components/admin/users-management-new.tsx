        ...
        <div className="fixed inset-0 bg-[#111]/40 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg p-6 max-w-lg w-full border border-black/[0.08]/50">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                <label className="block mb-2 font-medium text-[#111]">Admin module access</label>
                <p className="text-xs text-[#111]/55 mb-3">
                ...
                <div className="grid grid-cols-2 gap-2">
                  {(
                    ...
                    <label
                      key={key}
                      className="flex items-center gap-2 rounded-lg border border-black/[0.08]/50 bg-black/[0.04] px-3 py-2 text-sm cursor-pointer"
                    >
                      <input
                        type="checkbox"
