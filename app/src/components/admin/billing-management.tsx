    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap items-end gap-3">
        ...
        {view === "subscriptions" && !selectedCompanyId ? (
          <p className="text-sm text-[#111]/55 pb-2">
                        ...
                        return (
                          <Fragment key={rowKey}>
                            ...
                            {canShowLineItems && isExpanded && (
                              <tr
                                key={`${rowKey}-lines`}
                                className="border-b border-black/[0.08]/40 bg-black/[0.04]/10"
                              >
                    ...
                    <div className="flex flex-wrap items-start justify-between gap-3">
                      <div>
                        <CardTitle className="text-base font-medium">
                          {bill.recipientName}{" "}
                          <span className="text-[#111]/55 font-normal">
                            ({bill.recipientEmail})
                          </span>
                        </CardTitle>
                        <p className="text-sm text-[#111]/55 mt-1">
                      ...
                      <div className="mt-4 border-t pt-4 space-y-2">
                        {(chargesByBill[bill.id] || []).length === 0 ? (
                          ...
                          (chargesByBill[bill.id] || []).map((c) => (
                            <div
                              key={c.id}
                              className="border-b border-black/[0.08]/50 last:border-0 py-2"
                            >
                      ...
                      <ul className="space-y-1 border rounded-md p-3 max-h-40 overflow-y-auto">
                        {cronResult.billing.billDebug!.map((b) => (
                          <li key={b.id} className="flex justify-between gap-2">
                            ...
                            <span className="text-[#111]/55 shrink-0">
