...
export default function ProjectsManagementNew({
  ...
  return (
    <div>
      ...
      <div className="space-y-4">
        {companies.map((company) => {
          ...
          return (
            ...
            >
              <div className="bg-white rounded-lg border border-black/[0.08]/50 overflow-hidden">
                ...
                <CollapsibleContent>
                  <div className="p-4 pt-0">
                    {companyProjects.length > 0 ? (
                          ...
                          >
                              ...
                              {isSuperAdmin && (
                                <div className="flex gap-2">
                                  <button
                                    ...
                                    className="p-1.5 hover:bg-black/[0.06] rounded transition-colors"
                                    title="Edit project"
                                  >
                            ...
                            <div className="mt-auto space-y-3">
                              ...
                              <div className="space-y-1.5">
                                <p className="text-xs font-medium text-[#111]/55 flex items-center gap-1.5">
                                  <Key className="w-3.5 h-3.5" />
                                  API Key
                                </p>
                                <div className="flex items-center gap-2 flex-wrap">
                                  {projectApiKeyReveal[project.id] === undefined ? (
                                    <code className="text-xs bg-black/[0.04] px-2 py-1 rounded font-mono text-[#111]/55">
                                      ••••••••••••••••
                                    </code>
                                  ) : (
                                    <code className="text-xs bg-black/[0.04] px-2 py-1 rounded font-mono break-all max-w-full">
                                  ...
                                  <div className="flex items-center gap-1">
                                    <button
                                      ...
                                      className="p-1.5 hover:bg-black/[0.06] rounded transition-colors text-[#111]/55 hover:text-[#111] disabled:opacity-50"
                                      title={
                                        projectApiKeyReveal[project.id] !== undefined
                                          ? "Hide"
                                          : "Reveal"
                                    ...
                                    {projectApiKeyReveal[project.id] !== undefined &&
                                      ...
                                      projectApiKeyReveal[project.id] !== "(error)" && (
                                        <button
                                          ...
                                          className="p-1.5 hover:bg-black/[0.06] rounded transition-colors text-[#111]/55 hover:text-[#111]"
                                          title="Copy"
                                        >
                      ...
                      <div className="text-center py-8 text-[#111]/55">
      ...
      {projects.length === 0 && (
        <div className="text-center py-12 text-[#111]/55 bg-white rounded-lg border border-black/[0.08]/50">
      ...
      {/* Add/Edit Modal */}
      {showModal && (
        <div className="fixed inset-0 bg-[#111]/40 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg p-6 max-w-lg w-full border border-black/[0.08]/50 shadow-lg">
            <div className="flex items-center justify-between mb-4">
              ...
              <button
                onClick={closeModal}
                className="p-1 hover:bg-black/[0.06] rounded transition-colors"
              >
                <X className="w-5 h-5" />
              </button>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              {isSuperAdmin && (
                <div>
                  <label className="block mb-2 font-medium text-[#111]">Company *</label>
                  <select
                    value={formData.companyId}
                    onChange={(e) => setFormData({ ...formData, companyId: e.target.value })}
                    required
                    disabled={!isSuperAdmin}
                    className="w-full bg-black/[0.04] rounded-lg p-3 border border-black/[0.08]/50 focus:border-ring focus:ring-1 focus:ring-ring/40 focus:bg-white outline-none text-[#111] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                  >
              ...
              <div className="flex gap-3 justify-end pt-4">
                <button
                  type="button"
                  onClick={closeModal}
                  className="px-4 py-2 bg-black/[0.04] hover:bg-black/[0.06] rounded-lg transition-colors"
                  disabled={loading}
                >
                  Cancel
                </button>
