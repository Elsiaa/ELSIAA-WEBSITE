...
// pdfjs is browser-only (needs DOMMatrix); load lazily in effects.
    ...
    return (
      <div className="flex min-h-dvh items-center justify-center px-4">
        <div className="max-w-md text-center">
          <h1 className="mb-2 text-2xl font-semibold text-foreground">Unable to load document</h1>
      ...
      <div className="w-full max-w-7xl mx-auto px-4 py-8 space-y-6">
        ...
        <section className="space-y-8">
          ...
          <div className="pt-4 border-t border-border/60 space-y-3">
            {!isSubmitted && (
              <>
                <button
                  ...
                  className="inline-flex w-full justify-center rounded-xl bg-flame px-8 py-4 text-base font-semibold text-white hover:bg-coral disabled:cursor-not-allowed disabled:opacity-60"
                >
            ...
            {isSubmitted && (
              <div className="inline-flex w-full justify-center items-center gap-2 rounded-xl border border-primary/35 bg-primary/5 px-8 py-4 text-base font-semibold text-foreground">
        ...
        {showSignatureModal && activeField && (
          <div className="fixed inset-0 z-50 flex touch-none items-center justify-center bg-navy/40 px-3 backdrop-blur-[2px]">
                ...
                {activeField.field_type !== 'data_entry' && (
                  <div className="flex items-start gap-2 p-3 bg-muted/50 rounded-lg border border-border">
                    <input
                      ...
                      className="mt-0.5 h-4 w-4 rounded border-border accent-flame focus:ring-flame/40"
                    />
                    <label
  ...
  return (
    <div className="relative w-full overflow-x-auto">
      <div className="relative inline-block">
        ...
        <div className="absolute left-2 top-2 rounded bg-navy/85 px-2 py-1 text-xs text-white shadow-sm">
          Page {pageNumber}
        </div>
      </div>
    </div>
