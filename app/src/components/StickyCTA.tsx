...
export function StickyCTA() {
  ...
  return (
    <div
      ...
      style={{ paddingBottom: "max(0.75rem, env(safe-area-inset-bottom))", fontFamily: "-apple-system, BlinkMacSystemFont, 'SF Pro Display', 'SF Pro Text', 'Inter', system-ui, sans-serif" }}
    >
      <a
        href="/contact"
