        ...
        {chatState === 'sidebar' ? (
          <>
                ...
                <div className="flex items-center gap-1">
                  {isSuperAdmin && (
                    <button
                      ...
                      className="p-2 hover:bg-flame/20 rounded-lg text-flame transition-colors"
              ...
              {isLoadingMessages ? (
                <div className="flex-1 flex items-center justify-center">
                  <div className="flex flex-col items-center gap-3">
                    <div className="w-8 h-8 border-4 border-flame border-t-transparent rounded-full animate-spin" />
            ...
            <div className="p-4 border-t border-border bg-card/40">
              ...
              {audioBlob && (
                <div className="mb-2 bg-secondary/70 rounded px-3 py-2 flex items-center gap-2">
                  ...
                  <button
                    ...
                    className="bg-steel/90 hover:bg-navy rounded px-3 py-1 text-xs transition-colors"
                  ...
                  <button
                    ...
                    className="text-flame hover:text-coral transition-colors"
                  >
                    <X className="w-4 h-4" />
                  </button>
                </div>
              ...
              {isRecording && (
                <div className="mb-2 bg-flame/20 border border-flame/50 rounded px-3 py-2 flex items-center gap-2">
                  <div className="w-3 h-3 bg-flame rounded-full animate-pulse" />
                  <span className="text-sm flex-1">Recording... {formatTime(recordingTime)}</span>
                  <button
                    onClick={stopRecording}
                    className="bg-flame/90 hover:bg-coral rounded-lg p-2 transition-colors"
                  >
              ...
              <form onSubmit={handleSendMessage} className="flex items-center gap-2">
                ...
                <input
                  ref={messageInputRef}
                  name="message"
                  className="w-full bg-secondary/80 border border-border/50 rounded-lg px-3 py-2 text-foreground placeholder-muted-foreground focus:border-flame/50 focus:bg-secondary outline-none transition-colors"
                ...
                <button
                  type="submit"
                  className="bg-steel/90 hover:bg-navy rounded-lg p-2 disabled:opacity-50 transition-colors"
                  disabled={uploadingFiles || isRecording}
                >
                  {uploadingFiles ? (
            ...
            <div className="p-4 border-b border-border/50 flex justify-between items-center bg-card/40 relative z-10">
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end">
                  ...
                  <DropdownMenuItem asChild>
                    <Link href="/time-tracking" className="cursor-pointer flex items-center">
              ...
              <div className="p-4 border-b border-border/50 bg-card/20 space-y-3 relative z-10">
                <div>
                  ...
                  <select
                    ...
                    className="w-full bg-secondary border border-border/50 rounded-lg px-3 py-2 text-sm text-foreground focus:border-flame/50 focus:outline-none transition-colors"
                  >
              ...
              <div className="p-4 border-t border-border/50 bg-card/40">
                ...
                {audioBlob && (
                  <div className="mb-2 bg-secondary rounded px-3 py-2 flex items-center gap-2">
                    ...
                    <button
                      onClick={sendVoiceNote}
                      className="bg-flame hover:bg-coral rounded px-3 py-1 text-xs"
                      disabled={uploadingFiles}
                    >
                      Send
                    </button>
                ...
                {isRecording && (
                  <div className="mb-2 bg-flame/20 border border-flame rounded px-3 py-2 flex items-center gap-2">
                    <div className="w-3 h-3 bg-flame rounded-full animate-pulse" />
                    <span className="text-sm flex-1">Recording... {formatTime(recordingTime)}</span>
                    <button
                      onClick={stopRecording}
                      className="bg-flame hover:bg-coral rounded-lg p-2"
                    >
                      <Square className="w-4 h-4" />
                    </button>
                  </div>
                ...
                <form onSubmit={handleSendMessage} className="flex items-center gap-2">
                  ...
                  <input
                    name="message"
                    className="w-full bg-secondary border border-border rounded-lg px-3 py-2 text-foreground focus:border-flame outline-none"
                    placeholder="Type a message..."
                    disabled={uploadingFiles || isRecording}
                    onKeyDown={(e) => {
                      if (e.key === 'Enter' && !e.shiftKey) {
                  ...
                  <button
                    type="submit"
                    className="bg-flame hover:bg-coral rounded-lg p-2 disabled:opacity-50"
                    disabled={uploadingFiles || isRecording}
                  >
                    {uploadingFiles ? (
                      <div className="w-5 h-5 border-2 border-white border-t-transparent rounded-full animate-spin" />
            ...
            <div className="flex items-center justify-center h-full bg-background text-foreground">
              <div className="text-center max-w-md p-8">
                ...
                <div className="flex flex-col gap-3">
                  <a
                    href="/contact"
                    className="inline-block px-6 py-3 bg-flame hover:bg-coral rounded-lg transition-colors text-foreground font-medium"
                  >
