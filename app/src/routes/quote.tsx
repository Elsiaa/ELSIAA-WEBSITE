...
function QuotePage() {
  return (
    <main className="min-h-screen bg-[#FBFBFA] text-[#111111]">
      <SiteNav />
      <section className="mx-auto max-w-3xl px-6 pt-36 pb-8 md:pb-24 md:pt-44">
        ...
        <div className="flex items-start justify-between gap-8">
          <div className="min-w-0 flex-1">
            ...
            <p
              className="mt-3 text-[13px] text-[#1e6b3c] "
              style={{ fontFamily: "var(--font-sans)" }}
            >
              Quote delivered within 1 business day
            </p>
            <p className="mt-4 max-w-lg text-[15px] leading-relaxed text-[#111111]/60">
              A few focused questions — two minutes of your time. Your answers are distilled into a
              project brief for our team, and a personal quote comes back within one business day.
            </p>
          </div>
          <img
