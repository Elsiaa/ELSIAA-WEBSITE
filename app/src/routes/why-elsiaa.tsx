...
function WhyElsiaaPage() {
  return (
    <main style={{ fontFamily: SANS }} className="min-h-screen bg-white text-[#111111]">
      ...
      <section className="px-6 pt-36 pb-9 md:pt-44 md:pb-20">
      ...
      {/* ── about ELSIAA ── */}
      <section className="border-t border-black/[0.06] px-6 py-10 md:py-16">
      ...
      {/* ── outcome + CTA ── */}
      <section className="border-t border-black/[0.06] bg-[#F5F5F3] px-6 py-10 text-center md:py-16">
        <Reveal>
