  ...
  return (
    <main className="min-h-screen bg-white text-[#111111]">
      ...
      <article className="mx-auto max-w-2xl px-6 pt-40 pb-20 md:pt-44">
        ...
        <h1 className="mt-3 text-4xl font-semibold tracking-[-0.04em]" style={{ fontFamily: "'Schibsted Grotesk', -apple-system, BlinkMacSystemFont, 'SF Pro Display', 'SF Pro Text', 'Inter', system-ui, sans-serif" }}>Terms.</h1>
