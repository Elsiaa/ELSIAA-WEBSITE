...
export const Route = createFileRoute("/legal/terms")({
  ...
  head: () => ({
    meta: [
      { title: "Terms — ELSIAA" },
      { name: "description", content: "The terms governing use of the ELSIAA website and the services ELSIAA provides." },
  ...
  return (
    <main className="min-h-screen bg-white text-[#111111]">
      ...
      <article className="mx-auto max-w-2xl px-6 pt-40 pb-20 md:pt-44">
        ...
        <h1 className="mt-3 text-4xl font-semibold tracking-[-0.04em]" style={{ fontFamily: "var(--font-sans)" }}>Terms.</h1>
        ...
        <div className="mt-8 space-y-6 text-[14.5px] leading-[1.85] text-[#111111]/70" style={{ fontFamily: "var(--font-sans)" }}>
