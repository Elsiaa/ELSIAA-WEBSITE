...
function method(name: "GET" | "POST" | "PUT" | "PATCH" | "DELETE") {
  return async ({ request, params }: Ctx) => {
    const handlers = await import("../../../../../../poel-api/projects/[id]/subscriptions/[subscriptionId]/transactions/route");
...
export const Route = createFileRoute("/api/projects/$id/subscriptions/$subscriptionId/transactions")({
  server: {
    handlers: {
      GET: method("GET"),
      POST: method("POST"),
