...
export function Progress({
  ...
  if (shape === "circular") {
    ...
    return (
      <div
        ...
        className={cx("q-progress-circular", SIZE_CLASS[size], className)}
        style={rootStyle}
        {...props}
      >
        <svg className="q-progress-ring-svg" viewBox="0 0 100 100" aria-hidden>
          {svg}
        </svg>
        {center}
      </div>
  ...
  if (variant === "line") {
    return (
      <div
        {...aria}
        data-static={dataStatic}
        className={cx("q-progress-steps", SIZE_CLASS[size], className)}
        style={rootStyle}
        {...props}
      >
        {Array.from({ length: n }, (_, i) => {
  ...
  if (variant === "dots") {
    return (
      <div
        {...aria}
        data-static={dataStatic}
        className={cx("q-progress-dots", SIZE_CLASS[size], className)}
        style={rootStyle}
        {...props}
      >
        {Array.from({ length: n }, (_, i) => {
          ...
          return (
            <span
              ...
              data-state={i < filled ? "complete" : "pending"}
              style={{
                left: `calc(var(--q-progress-dot) / 2 + ${frac} * (100% - var(--q-progress-dot)))`,
              }}
            />
          );
        })}
  ...
  return (
    <div
      {...aria}
      data-static={dataStatic}
      className={cx("q-progress", SIZE_CLASS[size], className)}
      style={rootStyle}
      {...props}
    >
      <span
