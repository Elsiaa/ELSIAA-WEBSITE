...
describe("ButtonGroup", () => {
  ...
  it("forwards ref + extra props to the group div", () => {
    ...
    render(
      <ButtonGroup ref={ref} data-testid="grp">
        <Button>One</Button>
      </ButtonGroup>,
    );
  ...
  it("buttonGroup() recipe emits the same class string", () => {
    ...
    expect(buttonGroup({ orientation: "vertical", attached: false }, "extra")).toBe(
      "q-button-group q-button-group-vertical q-button-group-spaced extra",
    );
  });
});
