...
describe("<Sidebar>", () => {
    ...
    const { container } = render(
      <Sidebar.Root aria-label="Main">
        <Sidebar.Header>
          <Sidebar.Switcher>
            <Sidebar.Title>
              Cinema Studio <Sidebar.SwitcherChevron />
            </Sidebar.Title>
          </Sidebar.Switcher>
        </Sidebar.Header>
        <Sidebar.Body>
        ...
        <Sidebar.Footer>
          <Sidebar.FooterItem variant="login">
            <Sidebar.ItemLabel>Login</Sidebar.ItemLabel>
          </Sidebar.FooterItem>
        </Sidebar.Footer>
      </Sidebar.Root>,
    );
  ...
  it("carries the composite type utilities on the row parts (token adoption)", () => {
    ...
    expect(screen.getByText("Projects")).toHaveClass(
      ...
      "text-q-label-xs-medium",
    );
    expect(screen.getByText("Blue Horizon")).toHaveClass(
      "q-sidebar-label",
      "text-q-body-sm-medium",
    );
  ...
  it("applies footer variant classes (promo / login)", () => {
    const { rerender } = render(
      <Sidebar.FooterItem variant="promo">
        <Sidebar.ItemLabel>Pricing</Sidebar.ItemLabel>
      </Sidebar.FooterItem>,
    );
  ...
  it("renders a section header from SectionTitle + SectionActions", () => {
    ...
    expect(container.querySelector(".q-sidebar-section-actions")).toContainElement(
  ...
  it("renders the header switcher + a trailing toggle", () => {
    render(
      <Sidebar.Header>
        <Sidebar.Switcher>
          <Sidebar.Title>WS</Sidebar.Title>
        </Sidebar.Switcher>
  ...
  it("lets a custom Toggle onClick suppress the collapse via preventDefault", async () => {
    ...
    const { container } = render(
      <Sidebar.Root aria-label="Main">
        <Sidebar.Toggle onClick={onClick}>
          <span />
        </Sidebar.Toggle>
      </Sidebar.Root>,
    );
  ...
  it("expands a collapsed rail when the switcher is clicked, but not when expanded", async () => {
    ...
    const { container } = render(
      <Sidebar.Root defaultCollapsed aria-label="Main">
        <Sidebar.Header>
          <Sidebar.Switcher onClick={onClick}>
            <Sidebar.Logo>
              <span />
            </Sidebar.Logo>
          </Sidebar.Switcher>
