...
describe("button() class-builder", () => {
  ...
  it("includes special variants", () => {
    expect(button({ variant: "specialPink" })).toBe("q-button q-button-special-pink q-button-sm");
  });
});
...
describe("<Button>", () => {
  ...
  it("renders as a link via `as` (no type attribute)", () => {
    render(
      <Button as="a" href="/go" variant="ghost">
        Go
      </Button>,
    );
  ...
  it("renders marketing variants", () => {
    render(
      <Button variant="marketingTertiary" size="lg">
        Go
      </Button>,
    );
