...
): generation is Generation & { results: GenerationResults } {
...
export function isFromJob<Type extends string, Settings, Env>(
  ...
  model: Type;
  input: Generation["input"] & Env & { model: Type; settings: Settings };
} {
...
export function getMediaType(
  source: string | MediaRef | Generation | undefined,
): OutputType | undefined {
  if (source == null) return undefined;
  if (typeof source === "object" && "status" in source) return source.type;
