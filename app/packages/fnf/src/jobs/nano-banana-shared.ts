...
export type NanoBananaAspectRatioValue =
  (typeof NanoBananaAspectRatio)[keyof typeof NanoBananaAspectRatio];
export type NanoBananaConcreteRatio = Exclude<NanoBananaAspectRatioValue, "auto">;
export type NanoBananaResolution = "1k" | "2k" | "4k";

export const NANO_BANANA_ASPECT_RATIO_VALUES = [
  "auto",
  "1:1",
  "3:2",
  "2:3",
...
export const NANO_BANANA_CONCRETE_RATIOS = [
  "1:1",
  "2:3",
  "3:2",
  "3:4",
...
export const NANO_BANANA_SIZE_MAP: Record<
  NanoBananaResolution,
  Record<NanoBananaConcreteRatio, [number, number]>
> = {
  "1k": {
    "1:1": [1024, 1024],
    "2:3": [848, 1264],
...
export function resolveNanoBananaRatio(
  input: GenerationInput,
  roles: readonly string[],
  ratio: NanoBananaAspectRatioValue,
): NanoBananaConcreteRatio {
...
export function getNanoBananaDimensions(
  resolution: NanoBananaResolution,
  ratio: NanoBananaConcreteRatio,
