...
export type GptImage2AspectRatioValue =
  (typeof GptImage2AspectRatio)[keyof typeof GptImage2AspectRatio];
...
function dimensionsFor(aspectRatio: GptImage2AspectRatioValue, resolution: Resolution) {
  ...
  if (aspectRatio === "auto") return { width: base, height: base };
...
export const gptImage2 = defineJob({
  ...
  params: {
    ...
    settings: {
      aspectRatio: z.wire(
        "aspect_ratio",
        z._default(z.aspectRatio(Object.values(GptImage2AspectRatio)), "auto"),
      ),
