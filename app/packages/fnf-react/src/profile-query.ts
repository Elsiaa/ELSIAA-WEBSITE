...
export function profileSnapshotQueryOptions(
  ...
  opts?: ProfileCreditsQueryOptions,
) {
  return queryOptions({
...
export function profileUserQueryOptions(
  client: Pick<ProfileQueryClient, "getUser">,
  opts?: ProfileQueryOptions,
) {
  return queryOptions({
...
export function profileWorkspacesQueryOptions(
  client: Pick<ProfileQueryClient, "listWorkspaces">,
  opts?: ProfileQueryOptions,
) {
  return queryOptions({
...
export function profileCurrentWorkspaceQueryOptions(
  client: Pick<ProfileQueryClient, "getCurrentWorkspace">,
  opts?: ProfileQueryOptions,
) {
  return queryOptions({
...
export function profileWalletQueryOptions(
  client: Pick<ProfileQueryClient, "getWallet">,
  opts?: ProfileQueryOptions,
) {
  return queryOptions({
...
export function profileCreditsQueryOptions(
  client: Pick<ProfileQueryClient, "getCredits">,
  opts?: ProfileCreditsQueryOptions,
) {
  return queryOptions({
...
export function setProfileSnapshot(
  queryClient: QueryClient,
  snapshot: ProfileSnapshot,
  opts?: FnfScopeOptions,
): void {
  ...
  queryClient.setQueryData<ProfileWorkspace[]>(
    fnfKeys.profileWorkspaces(opts),
    snapshot.workspaces,
  );
  queryClient.setQueryData<ProfileWorkspace | null>(
    fnfKeys.profileCurrentWorkspace(opts),
    snapshot.currentWorkspace,
  );
  queryClient.setQueryData<ProfileWorkspaceWallet | null>(
    fnfKeys.profileWallet(opts),
    snapshot.wallet,
  );
